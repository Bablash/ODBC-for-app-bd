...
void employee_out(long employee_key, Employee employee) {
    cout << left << setw(7) << employee_key << left << setw(15) << employee.getSurname() << left << setw(13) << employee.getName() << left << setw(15) << employee.getPatronymic() << left << setw(25)<< employee.getAddress() << left << setw(15) << employee.getBirth() << left << setw(15) << employee.getPost() << left << setw(10) << employee.getSalary() << left << setw(12) << employee.getTransferNum() << left << setw(15) << employee.getPhone() << endl;
}
void employees_out() {
    map<long, Employee> employee = *(Repository::getInstance()->getEmplMap());
    cout << endl;
    cout << left << setw(7) << "[No]" << left << setw(15) << "Surname" << left << setw(13) << "Name" << left << setw(15) << "Patronymic" << left << setw(25) << "Address" << left << setw(15) << "Birth" << left << setw(15) << "Post" << left << setw(10) << "Salary" << left << setw(12) << "Transfer" << left << setw(15) << "Phone" << endl;
...
void transfer_out(long transfer_key, Transfer transfer) {
    cout << left << setw(7) << transfer_key << left << setw(12) << transfer.getNum() << left << setw(15) << transfer.getPost() << left << setw(50) << transfer.getReason() << left << setw(12) << transfer.getDate() << endl;
}
void transfers_out() {
    map<long, Transfer> transfer = *(Repository::getInstance()->getTransfMap());
    cout << endl;
    cout << left << setw(7) << "[No]" << left << setw(12) << "Number" << left << setw(15) << "Post" << left << setw(50) << "Reason" << left << setw(12) << "Date" << endl;
